...
func NewNotificationWebSocket(
	logger *logging.Logger,
	hub *NotificationHub,
	middlewareService middleware.JsonWebTokenMiddleware) *NotificationWebSocket {
...
func (ph *NotificationWebSocket) OnConnect(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	client := &NotificationClient{
		hub:     ph.hub,
		conn:    conn,
		send:    make(chan model.Notification, common.BUFFERED_CHANNEL_SIZE),
		session: session}
