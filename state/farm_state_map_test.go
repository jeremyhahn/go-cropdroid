...
func TestSerialization(t *testing.T) {
	...
	t2, _ := json.Marshal(controllerStateMap)
	println(string(t2))
	...
	println(fmt.Sprintf("%+v", farmStateMap.GetControllers()))
	println(fmt.Sprintf("%+v", farmStateMap.GetControllers()["testcontroller"]))
