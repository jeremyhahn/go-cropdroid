...
func NewSystemDiskKV(clusterID uint64, nodeID uint64) sm.IOnDiskStateMachine {
	d := &SystemDiskKV{
		clusterID: clusterID,
		nodeID:    nodeID,
	}
...
func (d *SystemDiskKV) queryAppliedIndex(db *pebbledb) (uint64, error) {
...
func (d *SystemDiskKV) Lookup(key interface{}) (interface{}, error) {
	...
	if db != nil {
		...
		if err == nil && d.closed {
			panic("lookup returned valid result when SystemDiskKV is already closed")
		}
...
func (d *SystemDiskKV) saveToWriter(db *pebbledb,
...
func (d *SystemDiskKV) SaveSnapshot(ctx interface{},
...
func (d *SystemDiskKV) RecoverFromSnapshot(r io.Reader,
