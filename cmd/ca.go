...
func init() {
	...
	caCmd.PersistentFlags().StringVarP(&CASubjectFile, "config", "c", "/etc/cropdroid/tls.yaml", "Path to TLS subject configuration file")
...
var caCmd = &cobra.Command{
	...
	Long: `The Certificate Authority provides Private Key Infrastructure (PKI)
		   ...
		   for secure web services, mTLS, encryption, and identity management.`,
