...
// 	GetConditions(session Session, channelID uint64) ([]*config.ConditionStruct, error)
// 	Create(session Session, condition *config.ConditionStruct) (*config.ConditionStruct, error)
// 	Update(session Session, condition *config.ConditionStruct) error
// 	Delete(session Session, condition *config.ConditionStruct) error
// 	IsTrue(condition *config.ConditionStruct, value float64) (bool, error)
// }
...
// 					err := func(condition *config.ConditionStruct) error {
// 						for _, device := range farmConfig.GetDevices() {
...
// // GetConditions retrieves a list of condition entries from the database
// func (service *DefaultConditionService) GetConditions(session Session, channelID uint64) ([]*config.ConditionStruct, error) {
// 	farmService := session.GetFarmService()
// 	farmConfig := farmService.GetConfig()
// 	orgID := farmConfig.GetOrganizationID()
// 	userID := session.GetUser().GetID()
...
// func (service *DefaultConditionService) Create(session Session, condition *config.ConditionStruct) (*config.ConditionStruct, error) {
...
// func (service *DefaultConditionService) Update(session Session, condition *config.ConditionStruct) error {
// 	farmService := session.GetFarmService()
// 	farmConfig := farmService.GetConfig()
// 	for _, device := range farmConfig.GetDevices() {
// 		for _, channel := range device.GetChannels() {
...
// func (service *DefaultConditionService) Delete(session Session, condition *config.ConditionStruct) error {
...
// func (service *DefaultConditionService) IsTrue(condition *config.ConditionStruct, value float64) (bool, error) {
