...
func CreateSmartSwitch(httpClient HttpClient, app *app.App, baseURL, deviceType string) SmartSwitcher {
...
func NewSmartSwitch(app *app.App, baseURL, deviceType string) SmartSwitcher {
