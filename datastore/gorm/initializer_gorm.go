...
func NewGormInitializer(logger *logging.Logger, db *gorm.DB, location *time.Location) DatabaseInitializer {
...
func (initializer *GormInitializer) seedInventory(db *gorm.DB) {
