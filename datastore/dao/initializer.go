...
func (initializer *ConfigInitializer) BuildConfig(params *common.ProvisionerParams,
	...
	drainStep.SetChannelID(reservoirDevice.GetChannels()[0].ID) // CHANNEL_RESERVOIR_DRAIN
	...
	fillStep.SetChannelID(reservoirDevice.GetChannels()[6].ID) // CHANNEL_RESERVOIR_FAUCET
	...
	phDownStep.SetChannelID(doserDevice.GetChannels()[0].ID) // CHANNEL_DOSER_PHDOWN
	...
	nutePart1Step.SetChannelID(doserDevice.GetChannels()[4].ID) // CHANNEL_DOSER_NUTE1
	...
	nutePart2Step.SetChannelID(doserDevice.GetChannels()[5].ID) // CHANNEL_DOSER_NUTE2
	...
	nutePart3Step.SetChannelID(doserDevice.GetChannels()[6].ID) // CHANNEL_DOSER_NUTE3
