...
func NewUnitTestSession() (*app.App, Session) {
	wd, _ := os.Getwd()
	...
	session := CreateSession(logger, farmService, &model.User{
		ID:       1,
...
func createTestFarm(farmID int, deviceType string) (config.FarmConfig, state.DeviceStateMap) {
